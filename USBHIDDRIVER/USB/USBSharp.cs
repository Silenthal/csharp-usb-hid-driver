...
namespace USBHIDDRIVER.USB
{
    ...
    public class USBSharp
    {
        ...
        private static extern unsafe void HidD_GetHidGuid(
            ref GUID lpHidGuid);
        ...
        //
        [DllImport("setupapi.dll", SetLastError = true)]
        private static extern unsafe int SetupDiEnumDeviceInterfaces(
            int DeviceInfoSet,
            int DeviceInfoData,
            ref  GUID lpHidGuid,
            int MemberIndex,
        ...
        [DllImport("setupapi.dll", SetLastError = true)]
        private static extern unsafe int SetupDiDestroyDeviceInfoList(
            int DeviceInfoSet				// IN HDEVINFO  DeviceInfoSet
            );

        // 13
        [DllImport("hid.dll", SetLastError = true)]
        private static extern unsafe int HidD_FreePreparsedData(
            int pPHIDP_PREPARSED_DATA			// IN PHIDP_PREPARSED_DATA  PreparsedData
            );
        ...
        #endregion Structs and DLL-Imports
